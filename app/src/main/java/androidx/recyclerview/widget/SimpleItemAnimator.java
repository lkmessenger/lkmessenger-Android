...
public abstract class SimpleItemAnimator extends RecyclerView.ItemAnimator {
     ...
     * {@link #animateChange(RecyclerView.ViewHolder, RecyclerView.ViewHolder, ItemHolderInfo, int, int, int, int)} implementation.
     ...
     *                                 {@link #animateChange(RecyclerView.ViewHolder, RecyclerView.ViewHolder, ItemHolderInfo, int, int, int,
     ...
     * {@link #animateMove(RecyclerView.ViewHolder, ItemHolderInfo, int, int, int, int) animateMove()},
     * {@link #animateRemove(RecyclerView.ViewHolder, ItemHolderInfo) animateRemove()}, and
     * {@link #animateChange(RecyclerView.ViewHolder, RecyclerView.ViewHolder, ItemHolderInfo, int, int, int, int)} come in one by one,
     ...
     *                {@link #animateChange(RecyclerView.ViewHolder, RecyclerView.ViewHolder, ItemHolderInfo, int, int, int, int)}).
     * @param oldItem true if this is the old item that was changed, false if
     *                it is the new item that replaced the old item.
     * @see #animateChange(RecyclerView.ViewHolder, RecyclerView.ViewHolder, ItemHolderInfo, int, int, int, int)
     */
