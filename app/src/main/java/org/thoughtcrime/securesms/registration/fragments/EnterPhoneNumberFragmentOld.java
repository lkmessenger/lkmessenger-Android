...
public final class EnterPhoneNumberFragmentOld extends LoggingFragment implements RegistrationNumberInputController.Callbacks {

  private static final String TAG = Log.tag(EnterPhoneNumberFragmentOld.class);
  ...
  public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
    ...
    imageButton = view.findViewById(R.id.open_country_picker_icon);
