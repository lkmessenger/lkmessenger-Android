...
import static org.thoughtcrime.securesms.dependencies.ApplicationDependencies.getApplication;
...
import org.linkmessenger.CustomKoinKt;
...
public class ApplicationContext extends MultiDexApplication implements AppForegroundObserver.Listener {
  ...
  public void onCreate() {
    ...
    CustomKoinKt.init(this);

    applicationHandler = new Handler(applicationContext.getMainLooper());


    AppStartup.getInstance()
            .addBlocking("firebase", ()-> {
    ...
    AppCenter.start(this, "f1c6a4dc-c58f-42df-adf5-25d78d15fc2e",
