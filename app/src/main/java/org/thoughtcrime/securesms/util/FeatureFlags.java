...
public final class FeatureFlags {
  ...
  public static boolean internalUser() {
    return getBoolean(INTERNAL_USER, true);
  }
  ...
  public static boolean phoneNumberPrivacy() {
    /*try {
      return FirebaseRemoteConfig.getInstance().getBoolean("android_pnp");
    }catch (Exception e){
      return false;
    }*/
  ...
  public static String paymentsCountryBlocklist() {
    return getString(PAYMENTS_COUNTRY_BLOCKLIST, "");
  }
  ...
  public static boolean stories() {
    return getBoolean(STORIES, true);
  }
  ...
  public static boolean storiesTextFunctions() {
    return getBoolean(STORIES_TEXT_FUNCTIONS, true);
  }
