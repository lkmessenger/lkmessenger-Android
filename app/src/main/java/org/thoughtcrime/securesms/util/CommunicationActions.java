...
public class CommunicationActions {
  ...
  public static boolean handlePotentialPostLinkUrl(@NonNull FragmentActivity activity, @NonNull String potentialPostLinkUrl) {
    try {
      return PostUtil.INSTANCE.handlePostUrl(activity, potentialPostLinkUrl);
    } catch (Exception e) {
      Log.w(TAG, "Post not found", e);
      Toast.makeText(activity, "Not found", Toast.LENGTH_SHORT).show();
      return true;
    }
  }
  public static boolean handlePotentialUsersLinkUrl(@NonNull FragmentActivity activity, @NonNull String potentialPostLinkUrl) {
    try {
      return PostUtil.INSTANCE.handleUserUrl(activity, potentialPostLinkUrl);
    } catch (Exception e) {
      Log.w(TAG, "Post not found", e);
      Toast.makeText(activity, "Not found", Toast.LENGTH_SHORT).show();
      return true;
