...
public class TextSecurePreferences {
  ...
  private static final String NEW_FOLLOWER_NOTIFICATION_PREF   = "pref_new_follower_notification";
  private static final String LIKE_NOTIFICATION_PREF           = "pref_like_notification";
  private static final String POST_COMMENTED_PREF              = "pref_post_commented";
  ...
  public static final String SHOW_PHONE_NUMBER                = "show_phone_number";
  public static final String MESSENGER_ACCESS                = "messenger_access";
  public static final String ONLINE_STATUS_PRIVACY                = "pref_online_status_privacy_secret";
  public static final String VERIFIED_ID                = "vid_";
  ...
  public static boolean isShowPhoneNumberEnabled(Context context) {
    return getBooleanPreference(context, SHOW_PHONE_NUMBER, false);
  }

  public static boolean isMessengerAccessEnabled(Context context) {
    return getBooleanPreference(context, MESSENGER_ACCESS, false);
  }
  public static boolean getOnlineStatusPrivacy(Context context) {
    return getBooleanPreference(context, ONLINE_STATUS_PRIVACY, true);
  }
  public static void setVerifiedId(Context context, String id, int status){
    setIntegerPrefrence(context, VERIFIED_ID+id, status);
  }
  public static int getVerifiedStatus(Context context, String id){
    return getIntegerPreference(context, VERIFIED_ID+id, 0);
  }
  ...
  @Deprecated
  public static boolean isNewFollowerNotificationEnabled(Context context) {
    return getBooleanPreference(context, NEW_FOLLOWER_NOTIFICATION_PREF, true);
  }

  @Deprecated
  public static boolean isLikeNotificationEnabled(Context context) {
    return getBooleanPreference(context, LIKE_NOTIFICATION_PREF, true);
  }

  @Deprecated
  public static boolean isPostCommentedNotificationEnabled(Context context) {
    return getBooleanPreference(context, POST_COMMENTED_PREF, true);
  }
