...
import org.linkmessenger.profile.view.activities.PostHiddenUsersActivity
...
class PrivacySettingsFragment : DSLSettingsFragment(R.string.preferences__privacy), KoinComponent {

  private lateinit var viewModel: PrivacySettingsViewModel
  private val profileViewModel: MyProfileViewModel = get()
  var isMessengerAccessEnabled: Boolean = true
...
//    isMessengerAccessEnabled = profileViewModel.privacySettings.value?.messengerAccess ?: true
  ...
  private fun getConfiguration(state: PrivacySettingsState): DSLConfiguration {
    return configure {
      ...
      clickLastPref(
        title = DSLSettingsText.from(R.string.hidden_users),
        onClick = {
          startActivity(PostHiddenUsersActivity.newIntent(requireContext()))
        }
      )
...
//      }
      ...
      switchPref(
        title = DSLSettingsText.from(R.string.preferences_app_protection__see_my_activity),
        summary = DSLSettingsText.from(R.string.preferences__if_activity_are_disabled_you_wont_be_able_to_see_activity),
        isChecked = state.onlineStatusPrivacy,
        onClick = {
          viewModel.setOnlinePrivacy(!state.onlineStatusPrivacy)
        }
      )
      clickLastPref(
...
//      switchFirstPref(
//              title = DSLSettingsText.from(R.string.show_my_phone_number),
//              summary = DSLSettingsText.from(getString(R.string.privacy_settings_phone_number_summary)),
//              isChecked = state.showPhoneNumber,
//              onClick = {
//                viewModel.setShowPhoneNumber(!state.showPhoneNumber)
//                profileViewModel.updatePrivacySettings(PrivacySettingsParams(!state.showPhoneNumber, null))
//              }
//      )
//
//      switchPref(
//              title = DSLSettingsText.from(getString(R.string.get_message_from_anyone)),
//              summary = DSLSettingsText.from(getString(R.string.privacy_settings_messenger_summa)),
//              isChecked = state.messengerAccess,
//              onClick = {
//                isMessengerAccessEnabled = !isMessengerAccessEnabled
//                viewModel.setMessengerAccess(!state.messengerAccess)
//                profileViewModel.updatePrivacySettings(PrivacySettingsParams(null, !isMessengerAccessEnabled))
//              }
//      )
