...
public class EmojiToggle extends AppCompatImageButton implements MediaKeyboard.MediaKeyboardListener {
  ...
  private void initialize() {
    this.emojiToggle   = ContextUtil.requireDrawable(getContext(), R.drawable.ic_fluent_emoji_24_regular);
    this.stickerToggle = ContextUtil.requireDrawable(getContext(), R.drawable.ic_fluent_sticker_24_regular);
    this.gifToggle     = ContextUtil.requireDrawable(getContext(), R.drawable.ic_fluent_gif_24_regular);
    this.imeToggle     = ContextUtil.requireDrawable(getContext(), R.drawable.ic_fluent_keyboard_24_regular);
