...
data class NotificationsSettingsState(
  ...
  val postNotificationsState: PostNotificationsState,
...
data class PostNotificationsState(
        val newFollowerNotificationEnabled: Boolean,
        val likeNotificationEnabled: Boolean,
        val postCommentedNotification: Boolean
)
