...
public final class AudioView extends FrameLayout {
  ...
  public AudioView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    try {
      ...
      setTint(typedArray.getColor(R.styleable.AudioView_foregroundTintColor, ContextCompat.getColor(context, R.color.conversation_outgoing_default_footer_color)));

      this.waveFormPlayedBarsColor   = typedArray.getColor(R.styleable.AudioView_waveformPlayedBarsColor, ContextCompat.getColor(context, R.color.conversation_outgoing_default_footer_color));
      this.waveFormUnplayedBarsColor = typedArray.getColor(R.styleable.AudioView_waveformUnplayedBarsColor, ContextCompat.getColor(context, R.color.conversation_outgoing_default_footer_color));
      this.waveFormThumbTint         = typedArray.getColor(R.styleable.AudioView_waveformThumbTint, ContextCompat.getColor(context, R.color.conversation_outgoing_default_footer_color));
