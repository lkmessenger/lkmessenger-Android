...
public final class PhoneNumberPrivacyValues extends SignalStoreValues {
  ...
  public @NonNull PhoneNumberSharingMode getPhoneNumberSharingMode() {
    if (!FeatureFlags.phoneNumberPrivacy()) return PhoneNumberSharingMode.NOBODY;
    return PhoneNumberSharingMode.values()[getInteger(SHARING_MODE, PhoneNumberSharingMode.NOBODY.ordinal())];
  }
  ...
  public enum OnlineStatusSharingMode {
    EVERYONE,
    NOBODY
  }
