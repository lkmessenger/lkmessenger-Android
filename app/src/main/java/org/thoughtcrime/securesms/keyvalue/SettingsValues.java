...
public final class SettingsValues extends SignalStoreValues {
  ...
  public static final  String LIKE_NOTIFICATION_ENABLED               = "settings.posts.like.notification.enabled";
  public static final  String NEW_FOLLOWER_NOTIFICATION_ENABLED       = "settings.posts.new.follower.notification.enabled";
  public static final  String POST_COMMENTED_NOTIFICATION_ENABLED     = "settings.posts.post.commented.notification.enabled";
  ...
  public boolean isNewFollowerNotificationEnabled() {
    return getBoolean(NEW_FOLLOWER_NOTIFICATION_ENABLED, TextSecurePreferences.isNewFollowerNotificationEnabled(ApplicationDependencies.getApplication()));
  }

  public boolean isLikeNotificationEnabled() {
    return getBoolean(LIKE_NOTIFICATION_ENABLED, TextSecurePreferences.isLikeNotificationEnabled(ApplicationDependencies.getApplication()));
  }

  public boolean isPostCommentedNotificationEnabled() {
    return getBoolean(POST_COMMENTED_NOTIFICATION_ENABLED, TextSecurePreferences.isPostCommentedNotificationEnabled(ApplicationDependencies.getApplication()));
  }
  ...
  public void setNewFollowerNotificationEnabled(boolean enabled) {
    putBoolean(NEW_FOLLOWER_NOTIFICATION_ENABLED, enabled);
  }

  public void setLikeNotificationEnabled(boolean enabled) {
    putBoolean(LIKE_NOTIFICATION_ENABLED, enabled);
  }

  public void setPostCommentedNotificationEnabled(boolean enabled) {
    putBoolean(POST_COMMENTED_NOTIFICATION_ENABLED, enabled);
  }

  public String setUserAvatar(String userId, String color){
    putString(userId, color);
    return color;
  }
  ...
  public String getUserAvatarIfExist(String userId){
    String avatarColor = SignalStore.settings().getUserAvatar(userId);

    if(avatarColor.isEmpty()){
      return SignalStore.settings().setUserAvatar(userId, AvatarColor.random().name());
    }
