                        ...
                        implements StickyHeaderDecoration.StickyHeaderAdapter<ConversationListSearchAdapter.HeaderViewHolder>
{
  ...
  static class SearchResultViewHolder extends RecyclerView.ViewHolder {
    ...
    {
      root.bindThread(lifecycleOwner, conversationResult, glideRequests, locale, Collections.emptySet(), Collections.emptySet(),Collections.emptyMap(), new ConversationSet(), query);
