...
public class StickerUrl {
  ...
  private static final Pattern STICKER_URL_PATTERN = Pattern.compile("^https://linkm\\.me/addstickers/#pack_id=(.*)&pack_key=(.*)$");
  ...
  public static @NonNull Uri createActionUri(@NonNull String packId, @NonNull String packKey) {
    return Uri.parse(String.format("link://addstickers?pack_id=%s&pack_key=%s", packId, packKey));
  }
  ...
  public static String createShareLink(@NonNull String packId, @NonNull String packKey) {
    return "https://linkm.me/addstickers/#pack_id=" + packId + "&pack_key=" + packKey;
  }
