...
class ConversationListTabsViewModelOld(repository: ConversationListTabRepository) : ViewModel() {
  ...
  class Factory(private val repository: ConversationListTabRepository) : ViewModelProvider.Factory {
    override fun <T : ViewModel> create(modelClass: Class<T>): T {
      return modelClass.cast(ConversationListTabsViewModelOld(repository)) as T
    }
  }
}
