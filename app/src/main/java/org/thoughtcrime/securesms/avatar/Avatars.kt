...
object Avatars {
  ...
  val defaultAvatarsForSelf = linkedMapOf(
    "icons8_deadpool" to DefaultAvatar(R.drawable.icons8_deadpool, "A130"),
    "icons8_finn" to DefaultAvatar(R.drawable.icons8_finn, "A120"),
    "icons8_cyborg" to DefaultAvatar(R.drawable.icons8_cyborg, "A170"),
    "icons8_luke_skywalker" to DefaultAvatar(R.drawable.icons8_luke_skywalker, "A190"),
    "icons8_michonne" to DefaultAvatar(R.drawable.icons8_michonne, "A140"),
    "icons8_princess_bubblegum" to DefaultAvatar(R.drawable.icons8_princess_bubblegum, "A190"),
    "icons8_super_mario" to DefaultAvatar(R.drawable.icons8_super_mario, "A120"),
    "icons8_smurf" to DefaultAvatar(R.drawable.icons8_smurf, "A160"),
    "icons8_thanos" to DefaultAvatar(R.drawable.icons8_thanos, "A130"),
    "icons8_grinch" to DefaultAvatar(R.drawable.icons8_grinch, "A180"),
    "icons8_brave" to DefaultAvatar(R.drawable.icons8_brave, "A220"),
    "icons8_black_widow" to DefaultAvatar(R.drawable.icons8_black_widow, "A100"),
    "icons8_ninja_turtle" to DefaultAvatar(R.drawable.icons8_ninja_turtle, "A220"),
    "icons8_rick_sanchez" to DefaultAvatar(R.drawable.icons8_rick_sanchez, "A160"),
    "icons8_stormtrooper" to DefaultAvatar(R.drawable.icons8_stormtrooper, "A130"),
    "icons8_spongebob_squarepants" to DefaultAvatar(R.drawable.icons8_spongebob_squarepants, "A180"),
  )
