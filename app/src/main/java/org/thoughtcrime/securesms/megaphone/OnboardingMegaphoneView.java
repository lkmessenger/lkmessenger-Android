...
public class OnboardingMegaphoneView extends FrameLayout {
  ...
  private static class GroupCardViewHolder extends CardViewHolder {
    ...
    @Override
    int getImageRes() {
      return R.drawable.ic_fluent_people_community_24_regular;
    }
  ...
  private static class InviteCardViewHolder extends CardViewHolder {
    ...
    @Override
    int getImageRes() {
      return R.drawable.ic_fluent_person_chat_24_regular;
    }
  ...
  private static class SmsCardViewHolder extends CardViewHolder {
    ...
    @Override
    int getImageRes() {
      return R.drawable.ic_fluent_chat_mail_20_regular;
    }
  ...
  private static class AppearanceCardViewHolder extends CardViewHolder {
    ...
    @Override
    int getImageRes() {
      return R.drawable.ic_fluent_color_24_regular;
    }
  ...
  private static class AddPhotoCardViewHolder extends CardViewHolder {
    ...
    @Override
    int getImageRes() {
      return R.drawable.ic_fluent_image_24_regular;
    }
