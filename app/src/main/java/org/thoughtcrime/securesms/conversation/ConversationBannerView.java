...
public class ConversationBannerView extends ConstraintLayout {
  ...
  public String setTitle(@NonNull Recipient recipient) {
    ...
    if (recipient.showVerified()) {
      ...
      Drawable drawable = ContextUtils.INSTANCE.getUserBadge(getContext(), recipient.getBadgeId(getContext()), 28);
      if (drawable!=null){
        SpanUtil.appendCenteredImageSpan(title, drawable, 28,28);
      }
    }
  ...
  private static final class FallbackPhotoProvider extends Recipient.FallbackPhotoProvider {
    ...
    public @NonNull FallbackContactPhoto getPhotoForRecipientWithoutName() {
      return new ResourceContactPhoto(R.drawable.ic_fluent_person_48_regular);
    }

    @Override
    public @NonNull FallbackContactPhoto getPhotoForGroup() {
      return new ResourceContactPhoto(R.drawable.ic_fluent_people_48_regular);
    }

    @Override
    public @NonNull FallbackContactPhoto getPhotoForLocalNumber() {
      return new ResourceContactPhoto(R.drawable.ic_fluent_note_48_regular);
    }
  }
}
