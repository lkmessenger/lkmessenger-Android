...
class Colorizer {
  ...
  @ColorInt
  fun getOutgoingDefaultBodyTextColor(context: Context): Int {
    return ContextCompat.getColor(context, R.color.conversation_outgoing_default_body_color)
  }
  ...
  @ColorInt
  fun getOutgoingDefaultFooterTextColor(context: Context): Int {
    return ContextCompat.getColor(context, R.color.conversation_outgoing_default_footer_color)
  }
  ...
  @ColorInt
  fun getOutgoingDefaultFooterIconColor(context: Context): Int {
    return ContextCompat.getColor(context, R.color.conversation_outgoing_default_footer_color)
  }
