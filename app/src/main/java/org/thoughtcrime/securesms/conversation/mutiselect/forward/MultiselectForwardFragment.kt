...
import org.thoughtcrime.securesms.contacts.paged.*
...
class MultiselectForwardFragment :
  ...
  override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
    ...
    contactSearchRecycler.layoutManager =
    ...
    val shareSelectionRecycler: RecyclerView = bottomBar.findViewById<RecyclerView?>(R.id.selected_list).apply {
  ...
  private fun onSend(sendButton: View) {
    ...
    }else if(args.postUrl != null){
      viewModel.sendPostUrl(args.postUrl.toString(), contactSearchMediator.getSelectedContacts())
    }
  }
