...
class MediaSelectionActivity :
  ...
  private val isAddingNewPost: Boolean
    get() = intent.getBooleanExtra(IS_ADDING_NEW_POST, false)
...
//    }
    ...
    val factory = MediaSelectionViewModel.Factory(destination, sendType, initialMedia, message, isReply, isStory, isAddingNewPost, MediaSelectionRepository(this))
  ...
  companion object {
    ...
    private const val IS_ADDING_NEW_POST = "is_adding_new_post"
    ...
    private fun buildIntent(
      ...
      return Intent(context, MediaSelectionActivity::class.java).apply {
        ...
        putExtra(IS_ADDING_NEW_POST, isAddingNewPost)
      }
    }
  }
