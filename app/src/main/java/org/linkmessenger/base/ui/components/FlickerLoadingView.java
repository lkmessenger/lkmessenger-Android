...
//                canvas.drawRoundRect(rectF, AndroidUtilities.dp(4), AndroidUtilities.dp(4), paint);
            ...
            if (backgroundPaint == null) {
                ...
                backgroundPaint.setColor(ContextCompat.getColor(getContext(), R.color.signal_colorSecondaryBackground));
            }
    ...
    public void updateColors() {
        ...
        int color0 = ContextCompat.getColor(getContext(), R.color.signal_colorBackground);
        int color1 = ContextCompat.getColor(getContext(), R.color.signal_colorSecondaryBackground);
    ...
    private int getCellHeight(int width) {
        switch (getViewType()) {
            case DIALOG_CELL_TYPE:
                return AndroidUtilities.dp((72) + 1);
            case DIALOG_TYPE:
