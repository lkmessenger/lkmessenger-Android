...
public class AboutLinkCellC extends FrameLayout {
...
//    private Theme.ResourcesProvider resourcesProvider;
    ...
    public AboutLinkCellC(Context context) {
        super(context);
...
//                                FileLog.e(e);
        ...
        container.addView(valueTextView, LayoutHelper.createFrame(LayoutHelper.WRAP_CONTENT, LayoutHelper.WRAP_CONTENT, (Gravity.LEFT) | Gravity.BOTTOM, 23, 0, 23, 10));
        ...
        showMoreTextView.setTextColor(ContextCompat.getColor(getContext(), R.color.signal_colorPrimary));
        ...
        showMoreBackgroundDrawable.setColorFilter(new PorterDuffColorFilter(ContextCompat.getColor(getContext(), R.color.signal_colorBackground), PorterDuff.Mode.MULTIPLY));
