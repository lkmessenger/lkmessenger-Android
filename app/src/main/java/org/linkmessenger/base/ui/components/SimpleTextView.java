            ...
            try {
                ...
                if (replacedText != null && replacedDrawable != null) {
                    ...
                    if (replacingDrawableTextIndex >= 0) {
                        ...
                        builder.setSpan(new FixedWidthSpan(replacedDrawable.getIntrinsicWidth()), replacingDrawableTextIndex, replacingDrawableTextIndex + replacedText.length(), 0);
                        text = builder;
                    } else {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (layout != null) {
            if (rightDrawableOutside || ellipsizeByGradient) {
                canvas.save();
                canvas.clipRect(0, 0, getMaxTextWidth() - paddingRight - AndroidUtilities.dp(rightDrawable != null && rightDrawableOutside ? 2 : 0), getMeasuredHeight());
            }
//            Emoji.emojiDrawingUseAlpha = usaAlphaForEmoji;
            ...
            if (fade) {
                ...
                canvas.save();
                canvas.translate(getMaxTextWidth() - paddingRight - AndroidUtilities.dp(rightDrawable != null && rightDrawableOutside ? 18 : 16), 0);
