...
public final class GroupInviteLinkUrl_InvalidGroupLinkException_Test {
  ...
  public void wrong_scheme() throws GroupInviteLinkUrl.InvalidGroupLinkException, GroupInviteLinkUrl.UnknownGroupLinkVersionException {
    assertNull(GroupInviteLinkUrl.fromUri("http://groups.linkm.me/#CjQKIAD34MKnGrBkzDztTATwjXt-9LhLLCIG9pgzvmz-NN-AEhCbwyTuxDfP2mrluK779H7o"));
  }

  @Test
  public void has_path() {
    assertThatThrownBy(() -> GroupInviteLinkUrl.fromUri("https://groups.linkm.me/not_expected/#CjQKIAD34MKnGrBkzDztTATwjXt-9LhLLCIG9pgzvmz-NN-AEhCbwyTuxDfP2mrluK779H7o"))
  ...
  public void missing_ref() {
    assertThatThrownBy(() -> GroupInviteLinkUrl.fromUri("https://groups.linkm.me/"))
                       .isInstanceOf(GroupInviteLinkUrl.InvalidGroupLinkException.class)
  ...
  public void bad_base64() {
    assertThatThrownBy(() -> GroupInviteLinkUrl.fromUri("https://groups.linkm.me/#CAESNAogpQEzURH6BON1bCS264cmTi37Yi6HTOReXZUEHdsBIgSEPCLfiL7k4wCX;mwVi31USVY"))
                      .isInstanceOf(GroupInviteLinkUrl.InvalidGroupLinkException.class)
  ...
  public void bad_protobuf() {
    assertThatThrownBy(() -> GroupInviteLinkUrl.fromUri("https://groups.linkm.me/#CAESNAogpQEzURH6BON1bCS264cmTi37Yi6HTOReXZUEHdsBIgSEPCLfiL7k4wCXmwVi31USVY"))
                      .isInstanceOf(GroupInviteLinkUrl.InvalidGroupLinkException.class)
  ...
  public void version_999_url() {
    String url = "https://groups.linkm.me/#uj4zCiDMSxlNUvF4bQ3z3fYzGyZTFbJ1xEqWbPE3uZSD8bjOrxIP8NxV-0GUz3jpxMLR1rN3";
  ...
  public void bad_master_key_length() {
    ...
    String url = "https://groups.linkm.me/#" + encoding;
